...
@section('Titulo','Simpsons Trivia')
@section('content')
  <!-- ANIMACIONES -->
  <div class="container containerr">
    <div class="row">
      <!--Bart-->
      <div id="bart" class="col-3 mt-auto">
  <div class="head">
  ...
  <!--Maggie-->
  <div id="maggie" class="col-3 mt-auto">
  <div class="head">
  ...
  <!--Marge-->
  <div id="marge" class="col-3 mt-auto">
  <div class="head">
    <div class="no-border body head-main"></div>
    <div class="body mouth-lip2"></div>
    <div class="body mouth-lip"></div>
  ...
  <!--Lisa-->
  <div id="lisa" class="col-3 mt-auto">
  <div class="head">
 ...
 <div class="container containeracercade">
    ...
    <p style="font-size: 16px; color: black;">Este sitio es una plataforma de entetenimiento en la cual deberás demostrar tu conocimiento dentro del Mundo Simpson.</p>
    </div>
    <div class="col-3 text-center">
    <ion-icon name="information-circle-outline" style="font-size: 25px;"></ion-icon>
    <p style="font-size: 16px; color: black;">Para poder acceder al juego tendrás que crear una cuenta dando click en el boton "Registrarse" en la parte superior derecha.</p>
    </div>
    <div class="col-3 text-center">
    <ion-icon name="information-circle-outline" style="font-size: 25px;"></ion-icon>
    <p style="font-size: 16px; color: black;">En caso de que ya tengas una cuenta puedes acceder a ella dando click en el boton "Iniciar Sesion" en la parte superior derecha.</p>
    </div>
    <div class="col-3 text-center">
    <ion-icon name="information-circle-outline" style="font-size: 25px;"></ion-icon>
    <p style="font-size: 16px; color: black;">Para obtener más información acerca del juego puedes acceder a las "Preguntas Frecuentes".</p>
</div>
</article>
</div>
...
<div class="col-md-12">
  ...
  <h3 style="font-family: 'Voltaire', sans-serif; color: black; font-size: 70px; text-align: center; padding-top: 100px;">EMPIEZA AHORA!</h3>
    ...
    <div class="col-md-12">
      <a href=" {{ url('/question') }}" style="text-decoration: none;"><button type="button" class="btn btn-warning btn-lg"><ion-icon name="play"></ion-icon>PLAY</button></a> <br>
        ...
        <h3 style="font-family: 'Voltaire', sans-serif; font-size: 45px; padding-top: 60px; padding-bottom: 50px;">CONTÁCTENOS</h3>

       <p style="font-size: 16px; color: black;">Para cualquier consulta, duda, sugerencia, aportación, y para casi todo lo que quieras en general, tenes dos formas de contactar con nosotros:</p>
       <div class="iconos">
       <a target="_blank" href="https://www.facebook.com/" style="padding-left: 3px"><i class="icon ion-logo-facebook"></i></a><br>
